...
<head>
    ...
    <script>
        function updateTotalPrice() {
            ...
            var basePrice = <?php echo isset($dress['BASE_PRICE']) ? $dress['BASE_PRICE'] : 0; ?>;
...
<body>
    ...
    if (isset($_POST['buy-dress'])) {
        ...
        if ($_SESSION["USER_ID"] == null) {
            ...
            $total_price = $dress['BASE_PRICE'] * $quantity; // Calculate total price based on quantity

            // Insert order details into the orders table
            $sql = "INSERT INTO orders(USER_ID, DRESS_ID, STATUSES, SSIZE, TOTAL_PRICE, QUANTITY, ESTIMATED_DELIVERY_DATE, ACTUAL_DELIVERY_DATE) 
                    VALUES ('$_SESSION[USER_ID]', '$dress_id', 'PENDING', '$_SESSION[SIZE]', '$total_price', '$quantity', '$estimate_date', '$actual_date')";
